...
const Sidebar = () => {
  ...
  return (
    ...
    <div className='bg-black    flex  justify-center items-center h-[100vh]'>
        <div className='flex flex-col    gap-4 bg-slate-200   p-3 rounded-md'>
        ...
        {sidebar && (
            ...
            <div className=' absolute h-screen  animate-movemenu p-1 z-10  flex flex-col justify-between      min-w-48 bg-slate-200 '> 
