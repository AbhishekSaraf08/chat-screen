...
const Sidebar = () => {
  ...
  return (
    <div className="bg-black    flex  justify-center items-center h-[100vh]">
      <div
        className="flex flex-col bg-gradient-to-r from-blue-100 via-yellow-100 to-blue-100
      ...
      {sidebar && (
        ...
        <div
          className=" absolute bg-gradient-to-r from-blue-200 via-yellow-100 to-blue-200
        ...
        >
          <div className="flex  flex-col gap-6">
            <div className="flex items-center gap-2">
              ...
              <CiViewList
                className="size-6 ml-10 cursor-pointer"
            ...
            <form className="flex justify-center relative">
              <input
                ...
                className="w-[90%] h-8 text-xs p-1 rounded-sm"
              />
              <button className="p-1  text-slate-500 absolute  text-center right-4">
                +
              </button>
            </form>
            <div className="flex flex-col gap-2 p-1">
              ...
              {today.map((value, index) => (
                <p
                  key={index}
                  className="text-sm text-slate-500  font-sans     hover:scale-105 transition-all duration-500 hover:text-black cursor-pointer"
                >
                  {value}
                </p>
              ))}
